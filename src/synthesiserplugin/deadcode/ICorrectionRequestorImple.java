 ...
 *
 * SPDX-License-Identifier: EPL-2.0//   w   ww    .d    em   o   2  s  .  c  om  
 *
 * Contributors:
...
public class ICorrectionRequestorImple implements ICorrectionRequestor {
	...
	public void acceptClass(char[] packageName, char[] className, char[] correctionName, int modifiers,
	...
	public void acceptField(char[] declaringTypePackageName, char[] declaringTypeName, char[] name,
			char[] typePackageName, char[] typeName, char[] correctionName, int modifiers, int correctionStart,
			int correctionEnd) {
		this.suggestions.add(new Suggestion(correctionName, correctionStart, correctionEnd));
	}

	public void acceptInterface(char[] packageName, char[] interfaceName, char[] correctionName, int modifiers,
			int correctionStart, int correctionEnd) {
		this.suggestions.add(new Suggestion(correctionName, correctionStart, correctionEnd));
	}
	...
	public void acceptMethod(char[] declaringTypePackageName, char[] declaringTypeName, char[] selector,
			...
			char[] returnTypePackageName, char[] returnTypeName, char[] correctionName, int modifiers,
			int correctionStart, int correctionEnd) {
		this.suggestions.add(new Suggestion(correctionName, correctionStart, correctionEnd));
	}
