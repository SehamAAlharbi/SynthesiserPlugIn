...
public class JavaProject {
	...
	public CompilationUnit getCUByName(String name) {
		CompilationUnit cu = this.compilationUnits.stream()
				.filter(cUnit -> cUnit.getJavaElement().getElementName().equalsIgnoreCase(name)).findFirst()
				.orElse(null);
		return cu;
	}
	...
	public ICompilationUnit getICUByName(String name) {
		ICompilationUnit cu = this.iCompilationUnits.stream()
				.filter(cUnit -> cUnit.getElementName().equalsIgnoreCase(name)).findFirst().orElse(null);
		return cu;
	}
	...
	public String toString() {
		return "JavaProject [projectName=" + projectName + ", folders=" + Arrays.toString(folders) + ", packages="
				+ packages + ", iCompilationUnits=" + iCompilationUnits + ", compilationUnits=" + compilationUnits
				+ "]";
	}
